"""
Django settings for round_band_98 project.
...
ROOT_URLCONF = 'round_band_98.urls'
...
WSGI_APPLICATION = 'round_band_98.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_band_98 API",
    "DESCRIPTION": "API documentation for round_band_98 App",
    "VERSION": "v1",
}
